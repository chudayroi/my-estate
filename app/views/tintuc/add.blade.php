                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group">
                              ...
                              <div class="">
                                 <input type="" class="form-control" id="datepicker_start" name="datepicker_start" value="{{$startdate}}" placeholder="">
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-6">
                           <div class="form-group">
                              ...
                              <div class="">
                                 <input type="" class="form-control" id="datepicker_finish" name="datepicker_finish" value="{{$enddate}}" placeholder="">
                              </div>
                           </div>
                        </div>
                     </div>
...
@section('js')
var href = "{{asset('/')}}/tintuc/edit/";
var src = "{{asset('/')}}/assets/img/news/";
//uploadhinh
