	...
	class Products extends Eloquent {
		...
		public static function loadMyTin($category_id){
        	...
        	//Log::info('user_id: '.$user_id);
				...
				$info = Products::Join('unit','unit.id','=','products.amount_unit_id')
								...
								->select('products.products_type_id as products_type_id','products.id as id','products.lt as lt','products.lg as lg','products.name as name','products.image as image','products.title as title','products.area as area','products.amount as amount','products.startdate as startdate',
		...
		public static function searchMyTin($info){
				...
				$data = Products::Join('unit','unit.id','=','products.amount_unit_id')
								...
								->select('products.products_type_id as products_type_id','products.id as id','products.lt as lt','products.lg as lg','products.name as name','products.title as title','products.image as image','products.area as area','products.amount as amount','products.startdate as startdate',
									     'district.name as district','city.name as city','city.title as city_title','unit.name as amount_unit','categories.name as category_name','categories.title as category_title')
								  ->get();
				return $data;
		}//End load Products
		...
		public static function loadDetailProduct($id){
				...
				$info = Products::Join('unit','unit.id','=','products.amount_unit_id')
								...
								->Select('products.products_type_id as products_type_id','products.id as id','products.lt as lt','products.lg as lg','products.name as name','products.title as title','products.content as content','products.content_summary as content_summary','products.area as area',
		...
		public static function loadMyProduct($category_id){
        	//Log::info('user_id: '.$user_id);
				...
				$data = Products::Join('unit','unit.id','=','products.amount_unit_id')
								...
								->Where('products.categories_id','like','%'.$category_id.'%')
								->orderBy('products.updated_at','DESC')
								->select('products.id as id','products.lt as lt','products.lg as lg','products.name as name','products.image as image','products.title as title','products.area as area','products.amount as amount','products.startdate as startdate',
									     'district.name as district','city.name as city','city.title as city_title','unit.name as amount_unit','categories.name as category_name','categories.title as category_title')
								  ->get();
				return $data;
		}//End load Products
		public static function loadMyProject(){
				$data = Products::Join('unit','unit.id','=','products.amount_unit_id')
								...
								->orderBy('products.updated_at','DESC')
								->take(3)
								->select('products.products_type_id as products_type_id','products.id as id','products.lt as lt','products.lg as lg','products.content as content','products.content_summary as content_summary','products.name as name','products.image as image','products.title as title','products.area as area','products.amount as amount','products.startdate as startdate',
									     'district.name as district','city.name as city','city.title as city_title','unit.name as amount_unit','categories.name as category_name','categories.title as category_title')
								  ->get();
				return $data;
		}//End load Products
		...
		public static function loadProductByType($category_id,$products_type){
        	//Log::info('user_id: '.$user_id);
				...
				$data = Products::Join('unit','unit.id','=','products.amount_unit_id')
								...
								->Where('products.categories_id','like','%'.$category_id.'%')
								->orderBy('products.updated_at','DESC')
								->select('products.products_type_id as products_type_id','products.id as id','products.lt as lt','products.lg as lg','products.name as name','products.content_summary as content_summary','products.image as image','products.title as title','products.area as area','products.amount as amount','products.startdate as startdate',
									     'district.name as district','city.name as city','city.title as city_title','unit.name as amount_unit','categories.name as category_name','categories.title as category_title')
								  ->get();
				return $data;
		}//End load Products
