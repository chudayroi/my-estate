...
Route::get('tuyendung','HomeController@loadTuyenDung');
...
Route::group(array('prefix'=>'first'),function(){
    ...
    Route::get('create','FirstDatabaseController@createstreet');
    Route::get('loadDistrict','FirstDatabaseController@loadDistrict');
    Route::get('loadMapCity','FirstDatabaseController@loadMapCity');
    Route::get('loadMapDistrict','FirstDatabaseController@loadMapDistrict');
    Route::get('loadMapStreet','FirstDatabaseController@loadMapStreet');
...
Route::group(array('prefix'=>'dangtin'),function(){
    ...
    Route::get('list/{page}','DangTinController@getMyDangTin');
...
Route::group(array('prefix'=>'{category}'),function(){
    ...
    Route::get('search','CategoryController@getCategorySearch');
    Route::get('{name}','CategoryController@getChitiet');
    Route::get('{city}/{page}','CategoryController@getCategoryCity');
    Route::get('{city}/{district}/{page}','CategoryController@getCategoryDistrict');
